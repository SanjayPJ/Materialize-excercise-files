...
.keyboard-focused input[type=range]:focus:not(.active)::-webkit-slider-thumb {
  -webkit-box-shadow: 0 0 0 10px rgba(21, 101, 192, 0.26);
          box-shadow: 0 0 0 10px rgba(21, 101, 192, 0.26);
}
...
.datepicker-day-button:focus {
  background-color: rgba(26, 101, 187, 0.25);
}
